...
const HelpModal2 = forwardRef((props, ref) => {
...
<ul style={{ marginLeft: '20px', marginBottom: '15px' }}>
  ...
  <li><strong>Automatisches und manuelles Speichern:</strong> Sobald das System Ihre Präferenz erkannt hat, speichert es diese automatisch. 
              Sie können einen der beiden Vorschläge aber auch vorher manuell speichern, indem Sie auf den Speicher Button <FaSave></FaSave> klicken.</li>
</ul>
